export const lang = {
  ...
  es: {
    ...
    LAYOUT: {
      NOTICE_TEXT: 'Si tienes alguna pregunta, contáctame.',
      PAY_BUTTON: 'Apoyar',
      NOTICE_BUTTON: 'Contacto',
      COMMENT_TITLE: 'Comentarios'
    },
    SEARCH: {
      ONLY_SEARCH: 'Buscar solo etiquetas',
    ...
    HERO: {
      HOME: {
        ...
        RSS_BUTTON: 'Suscribirse'
      },
      NEWSLETTER: {
        SUBSCRIPTION_HEAD: 'Canales de suscripción',
        TG_CHANNEL: 'Canal de Telegram',
        RSS_BUTTON: 'Suscribirse al RSS'
      },
      NOTES: {
        TEXT_FOOTER: 'Generado automáticamente desde la página de Craft.do'
      },
      RSS_BUTTON_DES: 'Lector de RSS',
      RSS_BUTTON_COPIED: 'Copiado',
      RSS_BUTTON_DES_COPIED: 'URL de RSS copiado'
    },
    CONTACT: {
      TITLE: 'Contacto',
      DESCRIPTION: 'Si tienes alguna pregunta o sugerencia, contáctame.',
      TG_DESCRIPTION: 'También puedes contactarme a través de Telegram: ',
      SUCCESS_MESSAGE: 'Mensaje enviado, te responderé lo antes posible.',
      FORM_USERNAME: 'Tu nombre',
      FORM_EMAIL: 'Tu correo electrónico*',
      FORM_CONTENT: 'Mensaje',
      SEND_BUTTON: 'Enviar',
      FORM_EMAIL_REQUIRED: '*Puedes proporcionar otros métodos de contacto válidos',
      FAILED_MESSAGE: 'Lo siento, no se pudo enviar el mensaje. Por favor, contáctame directamente en Telegram.'
    },
    FOOTER: {
      COPYRIGHT_START: 'Este sitio está licenciado bajo ',
      COPYRIGHT_NAME: 'CC BY-SA 4.0',
      COPYRIGHT_LINK: 'https://creativecommons.org/licenses/by-sa/4.0/',
      COPYRIGHT_END: '.'
    },
    ERROR: {
      MESSAGE: 'Se han producido algunos errores',
      TITLE: 'Página no encontrada',
      HELP_TEXT: 'Por favor, intenta actualizar la página o vuelve a la página de inicio y busca. Si tienes alguna pregunta, contáctame.',
      BACK_TO_HOME: 'Volver a inicio',
      CRAFTDOCS_ERROR: 'Si ves esta línea, significa que el formato de tu página de configuración de Craft.do es incorrecto.',
      LOADING: 'Cargando...',
      TIMEOUT_TEXT: '¿Esperando demasiado tiempo? Haz clic para visitar directamente la página de Notion.'
    }
}
}
