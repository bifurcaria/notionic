    ...
    >
      {pageTitle && (
        <Link
          ...
          scroll={false}
          className='block -ml-6 mb-2 p-2 hover:bg-neutral-200/50 hover:dark:bg-neutral-700 rounded-lg'
        >
      ...
      {nodes.map(node => (
        <div key={node.id} className='px-2 hover:bg-neutral-200/50 hover:dark:bg-neutral-700 rounded-lg'>
          <a
