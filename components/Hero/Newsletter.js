        ...
        <div className='flex flex-col md:w-4/5 md:items-start mb-6 md:mb-0 md:text-left'>
          ...
          <div className='flex flex-col sm:flex-row sm:justify-center gap-4'>
            <Link passHref href={BLOG.telegramChannelUrl} scroll={false} className='flex'>
              <button className='w-full bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-200/50 dark:hover:bg-neutral-600 inline-flex py-3 px-5 rounded-lg items-center'>
                <svg
            ...
            {showCopied ? (
              <button
                disabled
                className='bg-neutral-200/50 dark:bg-neutral-600 inline-flex py-3 px-5 rounded-lg items-center'
              >
              ...
              <button
                onClick={() => clickCopy()}
                className='bg-neutral-100 dark:bg-neutral-700 hover:bg-neutral-200/50 dark:hover:bg-neutral-600 inline-flex py-3 px-5 rounded-lg items-center'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='currentColor'
